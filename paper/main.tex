...
\begin{abstract}
    ...
    application processor. In this paper, a novel approach for the demodulation of the amplitude-modulated part of the signal, without the need for specialized
    ...
    As a result, the presented approach removes the need for most of the usually employed analog circuitry, leaving only a front-end amplifier, and
...
\begin{IEEEkeywords}
DCF77, SDR, Goertzel, DSP, Time Signal
\end{IEEEkeywords}

\section{Introduction}
    %End-user devices usually make use of the amplitude-modulated part of this signal by utilizing specialized ICs
    %together with big ferrite-rod antennas for obtaining the time signal. This signal then needs further hardware, often in form of microcontrollers,
    %to be used in the application. With increasing availability 
    
    %The demodulation and decoding of the amplitude and phase-modulated signal in the end-user devices
    %is usually done by using specialized ICs together with ferrite-rod antennas. With increasing availability of cheap In this paper, a n
