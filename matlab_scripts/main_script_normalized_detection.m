...
duration = 6; %Overall sampling duration in s (duration of the simulation)
...
goertzel_segments_results_normalized = goertzel_segments_magnitudes / max(goertzel_segments_magnitudes);
